...
* extension[accredited] MS
  ...
  * valueBoolean MS
* extension[zlogValue] ^definition = "Der zlog-Wert ist ein Relativwert, der auf einer logarithmischen Skala angibt, um wie viele Standardabweichungen ein Messwert vom Mittelwert des Referenzkollektivs abweicht. Er kann ergänzend, orientierend zur Bewertung eines Messergebnisses herangezogen werden.\n
...
Disclaimer: FHIR® definiert aktuell nur inklusive Richtgrenzen. Für die Praxistauglichkeit besteht aber die Anforderung, auch exklusive Richtgrenzen abbilden zu können. Diese Thematik wurde schon bei HL7® FHIR® platziert, es gibt aber noch keine abschließende Festlegung dazu. Im Informationsmodell sind beide Optionen bereits dargestellt, um diese Anforderung sichtbar zu machen."
    ...
    * unit MS
      * ^definition = "Die Einheit leitet sich aus der Messgröße (gemessene Eigenschaft und Mengenmaß) ab. Ein Beispiel: Wenn die Messgröße \"Massekonzentration pro Volumen\" ist, kommen als Einheiten mg/dl oder g/dl in Frage.\n
