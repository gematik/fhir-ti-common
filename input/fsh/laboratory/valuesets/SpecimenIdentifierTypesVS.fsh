...
ValueSet: SpecimenIdentifierTypeVS
Id: specimen-identifier-type
Title: "Specimen Identifier Type"
Description: "Dieses Valueset enthält Codes zur Typisierung des Proben-Identifikators."
* insert Meta-VS
* ^copyright = "This material derives from the HL7 Terminology (THO). THO is copyright ©1989+ Health Level Seven International and is made available under the CC0 designation. For more licensing information see: https://terminology.hl7.org/license.html"
* $cs-v2-0203|5.0.0#PLAC "Placer Identifier"
* $cs-v2-0203|5.0.0#ACSN "Accession ID"
* $cs-v2-0203|5.0.0#FILL "Filler Identifier"
* $cs-v2-0203|5.0.0#SID "Specimen ID"
* $cs-v2-0203|5.0.0#USID "Unique Specimen ID"
* $cs-v2-0203|5.0.0#SNO "Serial Number"
