...
Title: "Extension Pseudonymisierter Laborbefund"
...
* insert Meta
* . ^definition = "In dieser Extension kann ein Laborbefund als pseudonymisiert deklariert werden. Es kann bei der Steuerung der Übermittlungswege und für technische Validierung genutzt werden."
